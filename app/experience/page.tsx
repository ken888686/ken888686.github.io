...
export default function Experience() {
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <ol className="relative space-y-6 border-l pl-6 md:pl-8">
        {featuredExperiences.map((experience) => (
          <li key={experience.id} className="relative">
            <span className="border-background bg-primary absolute top-7 -left-[1.95rem] h-3 w-3 rounded-full border-2 md:-left-[2.45rem]" />
            <Card>
